...
system/startup_ldf/%.doj: ../system/startup_ldf/%.s
	...
	easmblkfn.exe -file-attr ProjectName="AudioNotchFilter" -proc ADSP-BF533 -si-revision 0.6 -g -D_DEBUG -i"C:\Users\kbe\Dropbox\ETISB\firstWeeks\AudioNotchFilter\system" -gnu-style-dependencies -MM -Mo "$(basename $@).d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
